...
open class ProfileListViewController: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        listLayout.collectionView.isSkeletonable = true
...
extension ProfileListViewController: SkeletonCollectionViewDelegate { }

extension ProfileListViewController: SkeletonCollectionViewDataSource {
