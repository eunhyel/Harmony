...
protocol NewImageCropViewControllerDelegate: AnyObject {
...
class NewImageCropViewController: UIViewController {
    ...
    let selectColor = UIColor(redF: 255, greenF: 68, blueF: 114)
    let unselectColor = UIColor(redF: 255, greenF: 255, blueF: 255)
