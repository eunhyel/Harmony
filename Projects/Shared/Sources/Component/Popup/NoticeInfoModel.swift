...
public struct NoticeInfoModel {
    ...
    public init(titleText: String, imageName: String?, contentsText: String, confirmBtnText: String, confirmAction: SimpleAction? = nil) {
    ...
    public var model: NoticeInfoModel {
        ...
        case .photoAuthFailure:
            return NoticeInfoModel(titleText: "사진이 인증되지 않았어요! 😅",
                                   imageName: nil,
                                   contentsText: "인증사진 주의사항을 참고해서 다시 시도해주세요!\n - 얼굴이 드러나야해요.", confirmBtnText: "다시 등록하기")
        case .photoAuthComplete:
            return NoticeInfoModel(titleText: "사진인증이 완료되었어요! 😊",
                                   imageName: nil,
                                   contentsText: "인증된 사진은 프로필 사진으로 등록이 가능합니다. 사진을 여러장 등록하면 다양한 매력을 보여줄 수 있어요!", confirmBtnText: "채팅 바로가기")
//        case .feedbackReport:
